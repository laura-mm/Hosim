...
*/
void plane(int v1, int v2, int v3)
{
	//ofstream fivefile; fivefile.open("five2_" + to_string(v1) + "_" + to_string(v2) + "_" + to_string(v3) + ".txt");
	//ofstream histfile; histfile.open("hist2_" + to_string(v1) + "_" + to_string(v2) + "_" + to_string(v3) + ".txt");
	ofstream colourfile; colourfile.open("colour23_" + to_string(v1) + "_" + to_string(v2) + "_" + to_string(v3) + ".txt");
	...
	for (int r = 0; r < runs; r++)
	{
		cout << "mu = " << v1 << ", sigma2 = " << sigma(0) << ", sigma3 = " << sigma(1) << ", run = " << r << endl;
...
int main(int argc, char** argv) // for condor
{
	...
	for (int i = 0; i <= 20; i++) sigma2val[i] = 0.1*(double)i;
	sigma3val = vector<double>(21);
	for (int i = 0; i <= 20; i++) sigma3val[i] = 0.1*(double)i;
